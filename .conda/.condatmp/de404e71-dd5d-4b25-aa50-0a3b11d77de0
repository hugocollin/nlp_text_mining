...
# installed.
TCL_PREFIX='d:/M2 SISE/Text Mining ou NLP/Projet/nlp_text_mining/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='d:/M2 SISE/Text Mining ou NLP/Projet/nlp_text_mining/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='d:/M2 SISE/Text Mining ou NLP/Projet/nlp_text_mining/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Id:/M2 SISE/Text Mining ou NLP/Projet/nlp_text_mining/.conda\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Ld:/M2 SISE/Text Mining ou NLP/Projet/nlp_text_mining/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='d:/M2 SISE/Text Mining ou NLP/Projet/nlp_text_mining/.conda\Library\lib\tclstub86.lib'
